	...
	<tr>
	 ...
	 <c:forEach items="${usuarios}" var="usuario">
		<tr>
            ...
            <td><a  href="<c:url value="/usuarios/${usuario.id}"/>">Ver JSON</a>
            <a onclick="return confirm('Esta seguro?');" href="<c:url value="/usuarios/${usuario.id}"/>">VER VER</a>
            </td>       
		</tr>
	 </c:forEach>
</table>
...
<p><a href="<c:url value="/usuarios/listado2.json"/>">Ver listado JSON</a></p>
